...
namespace StoreFront.UI.MVC.Controllers
{
    public class ProductStatusController : Controller
    {
        ...
        public ProductStatusController(AnimeShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductStatuses != null ? 
                          ...
                          Problem("Entity set 'AnimeShopContext.ProductStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductStatusId,StatusDescription")] ProductStatus productStatus)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AnimeShopContext.ProductStatuses'  is null.");
            }
            var productStatus = await _context.ProductStatuses.FindAsync(id);
            if (productStatus != null)
            {
